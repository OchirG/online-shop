...
<div class="form">
    ...
    <form class="login-form" action="/login" method="POST">
        ...
        <div class="options-02">
            <p>Not Registered? <a href="/registration">Create an Account</a></p>
        </div>
    </form>
...
<style>
    ...
    * {
    ...
    body {
        ...
        align-items: center;
        background: #111;
        background-image: url('<?php echo 'image/login.jpg'; ?>');
    }
    ...
    .form .btn:hover {
        border-left: solid 8px rgba(255, 255, 255, 0.96);
